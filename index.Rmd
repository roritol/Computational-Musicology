...
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/56quBtqjxzHDuphoB8GdP0?utm_source=generator" width="40%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/4sonZikgqtbefZyJy9mMl0?utm_source=generator" width="40%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
...
knitr::include_graphics("Plots/Nirvanamoretime.png")

knitr::include_graphics("Plots/BatmanTempo.png")
...
twenty_five %>% 
  ...
  scale_x_continuous(
    limits = c(0, 50)) +
  theme_minimal() +
  labs(x = "Time (s)", y = "", Title = "Wonderwall - Trailercore version", fill = "Magnitude")
```
...
knitr::include_graphics("Plots/JEBLIK.png")

knitr::include_graphics("Plots/Amsterdam.png")
